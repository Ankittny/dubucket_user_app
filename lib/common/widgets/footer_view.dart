...
class _FooterViewState extends State<FooterView> {
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisAlignment: MainAxisAlignment.start, children: [
      if (widget.removeSpace == false)
        ConstrainedBox(
          constraints: BoxConstraints(
              minHeight: (widget.visibility && ResponsiveHelper.isDesktop(context))
                      ...
                      children: [
                        ...
                        Expanded(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text('subscribe_to_out_new_channel_to_get_latest_updates'.tr,
                              ...
                              Container(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(
                                    ...
                                    expands: false,
                                    style:
                                        robotoMedium.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeExtraSmall),
                              ...
                              Row(children: [
                                _config!.landingPageLinks!.appUrlAndroidStatus == '1'
                                    ...
                                    : const SizedBox(),
                                SizedBox(
                                    width: _config.landingPageLinks!.appUrlAndroidStatus == '1'
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: Dimensions.paddingSizeDefault),
                                      FooterButton(
                                          title: 'privacy_policy'.tr, route: RouteHelper.getHtmlRoute('privacy-policy')),
                                      const SizedBox(height: Dimensions.paddingSizeDefault),
                                      FooterButton(
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title,
            style: hovered
                ? robotoMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)
