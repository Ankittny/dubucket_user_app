...
import 'package:dubucket/common/widgets/custom_tool_tip_widget.dart';
...
import 'package:dubucket/features/location/widgets/dynamic_text_color.dart';
...
import 'package:dubucket/features/location/domain/models/prediction_model.dart';
import 'package:dubucket/features/location/domain/models/zone_response_model.dart';
import 'package:dubucket/features/auth/controllers/auth_controller.dart';
import 'package:dubucket/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
import 'package:dubucket/common/widgets/custom_loader.dart';
...
import 'package:dubucket/features/location/widgets/landing_card_widget.dart';
import 'package:dubucket/features/location/widgets/registration_card_widget.dart';
...
class _WebLandingPageState extends State<WebLandingPage> {
          ...
          child: GetBuilder<SplashController>(
            builder: (splashController) {
              return splashController.landingModel == null
                  ? const WebLandingPageShimmerWidget()
                  : Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: ClipPath(
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImage(
                                image: 'assets/image/fixed_header_image.jpg',
                                height: 270,
                          ...
                          //     //               '',
                          //     //           style:
                          //     //               robotoBold.copyWith(fontSize: 35)),
                          //     //       const SizedBox(
                        ...
                        const SizedBox(height: 40),
                        (splashController.landingModel?.availableZoneStatus ==
                                    1 &&
                                splashController.landingModel!
                                    .availableZoneList!.isNotEmpty)
                            ? Row(children: [
                                Expanded(
                                  flex: 2,
                                  child: CustomImage(
                                    height: 350,
                                    image:
                                        '${splashController.landingModel?.availableZoneImageFullUrl}',
                                  ),
                                ),
                                                          ...
                                                          child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  modulesText
                                                                          .isEmpty
                                                                      ? 'no_modules_are_available'
                                                                          .tr
                                                                      : '$modulesText ${'modules_are_available'.tr}',
                                                                  style: robotoRegular.copyWith(
                                                                      color: Theme.of(
                                                                              context)
                                                                          .cardColor,
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: (splashController.landingModel
                                            ?.availableZoneStatus ==
                                        1 &&
                                    splashController.landingModel!
                                        .availableZoneList!.isNotEmpty)
                        ...
                        splashController.landingModel != null &&
                            ...
                            ? Row(
                                ...
                                children: [
                                    CustomImage(
                                      image:
                                          '${splashController.landingModel!.downloadUserAppImageFullUrl}',
                                      width: 500,
                                    ),
                                    Column(children: [
                                      Text(
  ...
  CustomButton _setLocation() {
    return CustomButton(
      ...
      onPressed: () async {
        await _goNextPageWithLatLng();
      },
    );
  }

  Future<void> _goNextPageWithLatLng() async {
    if (_address != null /* && _controller.text.trim().isNotEmpty*/) {
      print("_address_address_address ${_address?.longitude}");
      print("_address_address_address ${_address?.latitude}");
  ...
  List<Widget> _generateChooseUsList(SplashController splashController) {
    ...
    for (int index = 0;
      ...
      chooseUsList.add(Expanded(
          child: Row(children: [
        Expanded(
            child: LandingCardWidget(
          icon:
              '${splashController.landingModel!.specialCriterias![index].imageFullUrl}',
          title:
