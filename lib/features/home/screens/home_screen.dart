...
// import 'package:dubucket/features/home/widgets/all_store_filter_widget.dart';
import 'package:dubucket/features/home/widgets/cashback_logo_widget.dart';
import 'package:dubucket/features/home/widgets/cashback_dialog_widget.dart';
import 'package:dubucket/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:dubucket/features/home/screens/modules/food_home_screen.dart';
import 'package:dubucket/features/home/screens/modules/grocery_home_screen.dart';
import 'package:dubucket/features/home/screens/modules/pharmacy_home_screen.dart';
import 'package:dubucket/features/home/screens/modules/shop_home_screen.dart';
...
import 'package:dubucket/common/widgets/paginated_list_view.dart';
import 'package:dubucket/common/widgets/web_menu_bar.dart';
import 'package:dubucket/features/home/screens/web_new_home_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:dubucket/features/home/widgets/module_view.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    ...
    if (Get.find<SplashController>().module != null &&
        Get.find<SplashController>().module!.moduleType.toString() == AppConstants.pharmacy) {
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (!ResponsiveHelper.isWeb()) {
      Get.find<LocationController>().getZone(AddressHelper.getUserAddressFromSharedPref()!.latitude,
          AddressHelper.getUserAddressFromSharedPref()!.longitude, false,
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      bool isPharmacy =
          splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.pharmacy;
      bool isFood = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.food;
      bool isShop =
          splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.ecommerce;
      bool isGrocery =
          splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.grocery;
                                      ...
                                      Expanded(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.symmetric(
                                            ...
                                            horizontal:
                                                ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeSmall : 0,
                                          ),
                                ...
                                !showMobileModule
                                    ? SliverPersistentHeader(
                                        ...
                                        delegate: SliverDelegate(
                                          ...
                                          child: /*const AllStoreFilterWidget()*/ SizedBox(),
                                        ),
                                      )
                                    : const SliverToBoxAdapter(),
