...
import 'package:dubucket/common/widgets/confirmation_dialog.dart';
...
import 'package:dubucket/features/auth/widgets/business/base_card_widget.dart';
import 'package:dubucket/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:dubucket/features/auth/widgets/module_view_widget.dart';
import 'package:dubucket/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:dubucket/features/business/widgets/package_card_widget.dart';
...
import 'package:dubucket/features/auth/domain/models/store_body_model.dart';
import 'package:dubucket/common/models/translation.dart';
...
import 'package:dubucket/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:dubucket/features/auth/widgets/pass_view_widget.dart';
import 'package:dubucket/features/auth/widgets/select_location_view_widget.dart';
import 'package:dubucket/helper/responsive_helper.dart';
import 'package:dubucket/helper/validate_check.dart';
...
import 'package:dubucket/common/widgets/web_page_title_widget.dart';
...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Get.find<StoreRegistrationController>().getPackageList(isUpdate: false);
    ...
    return Column(children: [
      ...
      storeRegController.storeStatus != 0.9 ? Column(children: [
        Row(children: [
          ...
          Text('store_information'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
