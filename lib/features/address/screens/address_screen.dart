...
import 'package:dubucket/features/address/widgets/address_confirmation_dialogue.dart';
                                            ...
                                            child: GridView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                return (ResponsiveHelper.isDesktop(context) &&
                                                        (index == addressController.addressList!.length))
                                                    ? Container(
                                                    ...
                                                    : AddressWidget(
                                                        ...
                                                        onTap: () {
                                                          Get.toNamed(RouteHelper.getMapRoute(
                                                              addressController.addressList![index], 'address', false));
                                                        },
                                                        onEditPressed: () {
                                                          Get.toNamed(RouteHelper.getEditAddressRoute(
