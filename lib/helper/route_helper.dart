...
import 'package:dubucket/features/brands/screens/brands_product_screen.dart';
import 'package:dubucket/features/brands/screens/brands_screen.dart';
import 'package:dubucket/features/business/screens/subscription_payment_screen.dart';
import 'package:dubucket/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:dubucket/features/chat/domain/models/order_chat_model.dart';
import 'package:dubucket/features/loyalty/screens/loyalty_screen.dart';
import 'package:dubucket/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:dubucket/features/splash/controllers/splash_controller.dart';
import 'package:dubucket/features/notification/domain/models/notification_body_model.dart';
import 'package:dubucket/features/checkout/domain/models/place_order_body_model.dart';
import 'package:dubucket/features/auth/domain/models/social_log_in_body.dart';
import 'package:dubucket/features/address/domain/models/address_model.dart';
import 'package:dubucket/features/item/domain/models/basic_campaign_model.dart';
import 'package:dubucket/features/chat/domain/models/conversation_model.dart';
import 'package:dubucket/features/order/domain/models/order_model.dart';
import 'package:dubucket/features/item/domain/models/item_model.dart';
import 'package:dubucket/features/parcel/domain/models/parcel_category_model.dart';
import 'package:dubucket/features/store/domain/models/store_model.dart';
import 'package:dubucket/features/address/screens/add_address_screen.dart';
import 'package:dubucket/features/address/screens/address_screen.dart';
import 'package:dubucket/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:dubucket/features/auth/screens/sign_in_screen.dart';
import 'package:dubucket/features/auth/screens/sign_up_screen.dart';
import 'package:dubucket/features/auth/screens/store_registration_screen.dart';
import 'package:dubucket/features/category/screens/category_screen.dart';
import 'package:dubucket/features/location/screens/map_screen.dart';
import 'package:dubucket/features/store/screens/campaign_screen.dart';
import 'package:dubucket/helper/address_helper.dart';
import 'package:dubucket/helper/auth_helper.dart';
import 'package:dubucket/util/app_constants.dart';
import 'package:dubucket/util/html_type.dart';
import 'package:dubucket/common/widgets/image_viewer_screen.dart';
import 'package:dubucket/common/widgets/not_found.dart';
import 'package:dubucket/features/cart/screens/cart_screen.dart';
import 'package:dubucket/features/category/screens/category_item_screen.dart';
import 'package:dubucket/features/chat/screens/chat_screen.dart';
import 'package:dubucket/features/chat/screens/conversation_screen.dart';
import 'package:dubucket/features/checkout/screens/checkout_screen.dart';
import 'package:dubucket/features/payment/screens/offline_payment_screen.dart';
import 'package:dubucket/features/checkout/screens/order_successful_screen.dart';
import 'package:dubucket/features/payment/screens/payment_screen.dart';
import 'package:dubucket/features/payment/screens/payment_webview_screen.dart';
import 'package:dubucket/features/coupon/screens/coupon_screen.dart';
import 'package:dubucket/features/dashboard/screens/dashboard_screen.dart';
import 'package:dubucket/features/favourite/screens/favourite_screen.dart';
import 'package:dubucket/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:dubucket/features/item/screens/item_campaign_screen.dart';
import 'package:dubucket/features/item/screens/item_details_screen.dart';
import 'package:dubucket/features/item/screens/popular_item_screen.dart';
import 'package:dubucket/features/verification/screens/forget_pass_screen.dart';
import 'package:dubucket/features/verification/screens/new_pass_screen.dart';
import 'package:dubucket/features/verification/screens/verification_screen.dart';
import 'package:dubucket/features/html/screens/html_viewer_screen.dart';
import 'package:dubucket/features/interest/screens/interest_screen.dart';
import 'package:dubucket/features/language/screens/language_screen.dart';
import 'package:dubucket/features/location/screens/access_location_screen.dart';
import 'package:dubucket/features/location/screens/pick_map_screen.dart';
import 'package:dubucket/features/notification/screens/notification_screen.dart';
import 'package:dubucket/features/onboard/screens/onboarding_screen.dart';
import 'package:dubucket/features/order/screens/guest_track_order_screen.dart';
import 'package:dubucket/features/order/screens/order_details_screen.dart';
import 'package:dubucket/features/order/screens/order_screen.dart';
import 'package:dubucket/features/order/screens/order_tracking_screen.dart';
import 'package:dubucket/features/order/screens/refund_request_screen.dart';
import 'package:dubucket/features/parcel/screens/parcel_category_screen.dart';
import 'package:dubucket/features/parcel/screens/parcel_location_screen.dart';
import 'package:dubucket/features/parcel/screens/parcel_request_screen.dart';
import 'package:dubucket/features/profile/screens/profile_screen.dart';
import 'package:dubucket/features/profile/screens/update_profile_screen.dart';
import 'package:dubucket/features/store/screens/all_store_screen.dart';
import 'package:dubucket/features/store/screens/store_item_search_screen.dart';
import 'package:dubucket/features/store/screens/store_screen.dart';
import 'package:dubucket/features/review/screens/review_screen.dart';
import 'package:dubucket/features/search/screens/search_screen.dart';
import 'package:dubucket/features/splash/screens/splash_screen.dart';
import 'package:dubucket/features/support/screens/support_screen.dart';
import 'package:dubucket/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:dubucket/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  static Widget getRoute(Widget navigateTo,
    ...
    return  (AddressHelper.getUserAddressFromSharedPref() == null && !byPuss)
        ? AccessLocationScreen(fromSignUp: false, fromHome: false, route: Get.currentRoute)
        : navigateTo;
    /*(AppConstants.appVersion != minimumVersion.toString() &&
            !GetPlatform.isWeb)
